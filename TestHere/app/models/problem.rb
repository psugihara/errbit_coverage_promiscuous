...
class Problem
  ...
  subscribe :last_notice_at, :first_notice_at, :last_deploy_at, :resolved,
  :resolved_at, :issue_link, :issue_type, :app_name, :notices_count,
  :message, :environment, :error_class, :where, :user_agents, :messages,
  :hosts, :comments_count, :app, :errs, :comments
